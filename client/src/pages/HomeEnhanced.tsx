        ...
        <div className="container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 hidden lg:block">
              <GlassCard className="absolute top-0 right-0 w-72 animate-float">
              ...
              <GlassCard className="absolute top-40 left-0 w-72 animate-float" style={{ animationDelay: '0.5s' }}>
                <div className="flex items-center gap-3 mb-3">
              ...
              <GlassCard className="absolute bottom-0 right-20 w-72 animate-float" style={{ animationDelay: '1s' }}>
                <div className="flex items-center gap-3 mb-3">
